...
// The clear-everything control is available by default, including on the deployed site.
// It is reachable only by a signed-in admin and needs RESET typed to confirm. Set
// ALLOW_DATA_RESET (or DEMO_MODE) to false/0/off/no to remove it from a deployment.
function isResetAllowed(bindings) {
